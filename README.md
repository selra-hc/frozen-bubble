...
- Android NDK (for native `libmodplug` builds)

Useful commands:
- `./gradlew assembleDebug` (full build, requires NDK)
- `./gradlew -PskipNativeBuild=true assembleDebug` (Java/resources validation only)
